...
<script type="application/javascript">
  ...
  window.onload = function () {
    ...
    load_image('image_afert_js_load_0sm',0,'high')
    load_image('image_afert_js_load_100sm',100,'high')
    load_image('image_afert_js_load_200sm',200,'high')
    load_image('image_afert_js_load_300sm',300,'high')
    load_image('image_afert_js_load_400sm',400,'high')
    load_image('image_afert_js_load_500sm',500,'high')
    load_image('image_afert_js_load_600sm',600,'high')
    load_image('image_afert_js_load_700sm',700,'high')
    load_image('image_afert_js_load_800sm',800,'high')
    load_image('image_afert_js_load_900sm',900,'high')
