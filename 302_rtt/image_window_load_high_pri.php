...
<script type="application/javascript">
  ...
  window.onload = function () {
    ...
    load_image('img_after_window_load_high_pri_100sm',100,'high')
    load_image('img_after_window_load_high_pri_200sm',200,'high')
    load_image('img_after_window_load_high_pri_300sm',300,'high')
    load_image('img_after_window_load_high_pri_400sm',400,'high')
    load_image('img_after_window_load_high_pri_500sm',500,'high')
    load_image('img_after_window_load_high_pri_600sm',600,'high')
    load_image('img_after_window_load_high_pri_700sm',700,'high')
    load_image('img_after_window_load_high_pri_800sm',800,'high')
    load_image('img_after_window_load_high_pri_900sm',900,'high')
